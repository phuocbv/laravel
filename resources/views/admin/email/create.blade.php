...
@section('content')
    <div class="page-header">
        <h1><span class="text-muted font-weight-light"><i class="page-header-icon fa  fa-envelope"></i>Email / </span>Add Email Account</h1>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal"
                          id="create_form"
                          method="post"
                          action="{{ route('admin.email.create') }}"
                          autocomplete="off">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div id="div_shopify">
                                    <div class="form-group {{ $errors->has('shopify_key') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="shopify_key" value="{{ old('shopify_key') }}">
                                    ...
                                    <div class="form-group {{ $errors->has('shopify_pass') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="shopify_pass" value="{{ old('shopify_pass') }}">
                                    ...
                                    <div class="form-group {{ $errors->has('shopify_hostname') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="shopify_hostname" placeholder="ex:azstoreus.myshopify.com" value="{{ old('shopify_hostname') }}">
                                    ...
                                    <div class="form-group {{ $errors->has('shopify_shared_secret') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="shopify_shared_secret" value="{{ old('shopify_shared_secret') }}">
                                ...
                                <div id="div_ebay" style="display: none;">
                                    ...
                                    <div class="form-group {{ $errors->has('ebay_access_token') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="ebay_access_token" name="ebay_access_token">{{ old('ebay_access_token') }}</textarea>
                                    ...
                                    <div class="form-group {{ $errors->has('ebay_refresh_token') ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea id="ebay_refresh_token" class="form-control" name="ebay_refresh_token">{{ old('ebay_refresh_token') }}</textarea>
